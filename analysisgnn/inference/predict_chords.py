import pandas as pd
from analysisgnn.utils.chord_representations import solveChordSegmentation, resolveRomanNumeralCosine, formatRomanNumeral, formatChordLabel, generateRomanText
import copy, os
import numpy as np
import partitura as pt
# Testing with pretrained model
from analysisgnn.utils.chord_representations_latest import available_representations
from analysisgnn.models.chord import ChordPrediction, PostChordPrediction
import torch
import argparse
...
parser.add_argument("--input_score", type=str, help="Path to musicxml input score")
...
print("Done! Score saved at: ", f"./artifacts/{os.path.splitext(os.path.basename(args.input_score))[0]}_rna.musicxml")