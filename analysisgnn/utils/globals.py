''' Should contain names of descriptors and globals.'''
import pandas as pd
...
M21_ACCIDENTALS_DOUBLE = ("--", "-", "", "#", "##")

M21_PITCH_SPELLING = [              # 7 x 5 = 35 (this excludes 3 more with triple acc.)
    f"{letter}{accidental}"
    for letter in NOTENAMES
    for accidental in M21_ACCIDENTALS_DOUBLE
]

NORMAL_ACCIDENTALS_TRIPLE = ("bbb", "bb", "b", "", "#", "##", "###")

DEGREES = ("1", "2", "3", "4", "5", "6", "7")

NOTE_DEGREES = [                    # 7 x 7 = 49
    f"{accidental}{degree}"
    for degree in DEGREES
    for accidental in NORMAL_ACCIDENTALS_TRIPLE
]
...
EMPIRICAL_TONE_FUNCTIONS = { # these are 38 bass and root values, here with normal accidentals
    'A': 'A',
    'A#': 'A#',
    'A##': 'A##',
    'Ab': 'A-',
...
EMPIRICAL_KEYS = { # the 50 values that occur as localKey or tonicizedKey
    'A': 'A',
    'A#': 'A#',
    'Ab': 'A-',
    'Abb': 'A--',
    ...
    'g#': 'g#',
    'gb': 'g-',
    # currently no None value:  's
}




EMPIRICAL_DOWNBEATS = list(range(45)) # these are the 45 downbeats that can occur in the wild



# The keys used for transposition (data augmentation)
TRANSPOSITIONKEYS = tuple(M21_KEYS)
