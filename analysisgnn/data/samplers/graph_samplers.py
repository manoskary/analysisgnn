...
class ScoreGraphSubSampler():
    def __init__(self, subsampled_max_lenght : int) -> None:
        self.subsampled_note_lenght = subsampled_max_lenght

    def __call__(self, data):
        data.x = data.x[::self.subsampled_max_lenght]
        data.edge_index = data.edge_index[:, ::self.subsampled_max_lenght]
        data.edge_attr = data.edge_attr[::self.subsampled_max_lenght]
        data.y = data.y[::self.subsampled_max_lenght]
        return data
